...
export const AnimatedThemeToggler = ({
  ...
  const [internalIsDark, setInternalIsDark] = useState(() => {
    // Check initial state applied by index.html script to avoid hydration mismatch/sync issues
  ...
  return (
    <button
      ...
      title={props.title}
    >
      {children ? (typeof children === 'function' ? children(isDark) : children) : (isDark ? <Sun /> : <Moon />)}
