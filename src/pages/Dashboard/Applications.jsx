          ...
          <table className="applications-table">
            <thead>
              <tr>
                ...
                >
                  Scheme Name <i className={getSortIcon('schemeName')}></i>
                </th>
                <th
                  onClick={() => handleSort('id')}
                  style={{ cursor: 'pointer', userSelect: 'none' }}
                >
                  Application ID <i className={getSortIcon('id')}></i>
                </th>
                <th
                  onClick={() => handleSort('dateApplied')}
                  style={{ cursor: 'pointer', userSelect: 'none' }}
                >
                  Application Date <i className={getSortIcon('dateApplied')}></i>
                </th>
                <th
                ...
                return (
                  <React.Fragment key={app.id}>
                    <tr
                      ...
                      className={expandedRowId === app.id ? 'active-row' : ''}
                    >
                      <td className="fw-600">{app.schemeName || app.name}</td>
                      <td>
                        {typeof app.id === 'string' && app.id.startsWith('APP')
                          ? app.id
                          : typeof app.id === 'number' && app.id < 1000
                            ? `APP-2023-894${app.id}`
                            : app.id}
                      </td>
                      <td>{app.dateApplied || app.date || '12 Oct 2023'}</td>
                      <td>
                        <span className={`status-badge-soft ${badgeClass}`}>{app.status}</span>
                      </td>
                      <td>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                          <button className="btn-view-details">View Details</button>
                          <i
                            className={`fa-solid fa-chevron-${expandedRowId === app.id ? 'up' : 'down'}`}
                            style={{ color: '#94a3b8' }}
                          ></i>
                        </div>
                      </td>
                          ...
                          <div className="expanded-card">
                            <div className="adaptive-card-summary-v2">
                              <div className="acs2-header-section">
                                <span
                                  className={`acs2-status-badge ${app.status === 'Approved' ? 'disbursed' : app.status.toLowerCase()}`}
                                >
                                  {app.status === 'Approved' ? 'Disbursed' : app.status}{' '}
                                  <i className="fa-solid fa-circle-info"></i>
                                </span>
                                <div className="acs2-header-titles">
                                  <h4>
                                    {app.schemeName || app.name} |{' '}
                                    {app.id < 1000 ? `APP-2023-894${app.id}` : app.id}
                                  </h4>
                              ...
                              <div className="acs2-main-layout">
                                <div className="acs2-left-sidebar">
                                  ...
                                  <p className="acs2-summary-text">
                                    PM-KISAN Samman Nidhi; PM-KISAN Samman Nidhi for aown completion
                                    applications. Scheme a size to ortor's application regard and
                                    scheme application.
                                  </p>
                                  <div className="acs2-divider"></div>
                                  <h5 className="acs2-title">Key Terms</h5>
                                  <p className="acs2-summary-text">
                                    Fairor: Aadhar verification failed or Missing document in PM-JAY
                                    application as Sanctioned, over terms within application as
                                    Sancioned.
                                  </p>
                                </div>
                                ...
                                <div className="acs2-right-content">
                                  <div className="acs2-stepper-box">
                                    <div className="acs2-box-header">
                                      ...
                                      <button
                                        className="acs2-help-btn"
                                        onClick={(e) => {
                                          e.stopPropagation();
                                          setHelpDrawerAppId(app.id);
                                        }}
                                      >
                                        ...
                                        <div className="help-popover">
                                          ...
                                          <p>
                                            Your PM-KISAN funds have been successfully disbursed.
                                            However, a routine post-disbursal audit flagged a
                                            missing or unreadable Aadhar document. Please upload a
                                            clear copy of your Aadhar card to clear this dependency
                                            and prevent holds on future disbursals.
                                          </p>
                                        </div>
                                      </button>
                                    </div>
                                    <div className="inline-stepper">
                                      ...
                                      <div
                                        className={`stepper-progress ${app.status.toLowerCase()}`}
                                      ></div>
                                      ...
                                      <div className="stepper-step completed">
                                        ...
                                        <div className="step-sublabel">
                                          {app.dateApplied || 'Oct 10, 2023'}
                                        </div>
                                      </div>
                                      <div
                                        className={`stepper-step ${['Approved', 'Rejected'].includes(app.status) ? 'completed' : 'active'}`}
                                      >
                                        <div className="step-dot"></div>
                                      ...
                                      <div
                                        className={`stepper-step hoverable ${app.status === 'Approved' ? 'completed' : app.status === 'Rejected' ? 'rejected' : ''}`}
                                      >
                                        <div className="step-dot"></div>
                                      ...
                                      <div
                                        className={`stepper-step ${app.status === 'Approved' ? 'completed' : ''}`}
                                      >
                                        <div className="step-dot"></div>
                                        <div className="step-label">Sanction</div>
                                        <div className="step-sublabel">
                                          {app.status === 'Approved' ? 'Oct 20, 2023' : ''}
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  <div className="acs2-bottom-grid">
                                          ...
                                          app.documents.map((docItem, dIdx) => (
                                            ...
                                            >
                                              <div className="doc-name">
                                                ...
                                                {docItem.name || `Document ${dIdx + 1}`}
                                              </div>
                                              <div className="doc-status">
                                                <i className="fa-solid fa-circle-check"></i> View /
                                                Download{' '}
                                                <i
                                    ...
                                    <div className="acs2-col-box">
                                      ...
                                      <div className="acs2-notes-list">
                                        <div className="acs2-note-card yellow">
                                          ...
                                          <p>
                                            Missing document: Aadhar verification failed or Missing
                                            document in PM-JAY application as San...
                                          </p>
                                          <div className="note-footer">
                                            Audit Officer: S. Sharma
                                          </div>
                                        </div>
                                        <div className="acs2-note-card blue">
                                          ...
                                          <p>
                                            Aadhar data re-verification required per post-facto
                                            audit
                                          </p>
                                        ...
                                        <div className="acs2-note-card yellow">
                                          ...
                                          <p>
                                            Missing document: Aadhar verification failed application
                                            as Sanctioned.
                                          </p>
                                          <div className="note-footer">
                                            Audit Officer: S. Sharma
                                    ...
                                    <div className="acs2-col-box transparent-col">
                                      <div className="acs2-inner-col">
                                        <div
                                          className="acs2-box-header"
                                          style={{ marginBottom: '12px' }}
                                        >
                                          <h5 className="acs2-title" style={{ margin: 0 }}>
                                            Resolve Conflict & Quick Actions
                                          </h5>
                                          <button
                                            className="acs2-help-btn"
                                            onClick={(e) => {
                                          ...
                                          >
                                            ...
                                            <div className="help-popover">
                                              <strong>Post-Audit Action Required</strong>
                                              <p>
                                                Your PM-KISAN funds have been successfully
                                                disbursed. However, a routine post-disbursal audit
                                                flagged a missing or unreadable Aadhar document.
                                                Please upload a clear copy of your Aadhar card to
                                                clear this dependency and prevent holds on future
                                                disbursals.
                                              </p>
                                            </div>
                                          </button>
                                        </div>
                                        <p className="acs2-review-summary">
                                          Review Summary: Post-Disbursal Review conditional
                                          dependencies found
                                        </p>
                                        <button className="acs2-btn-primary">
                                          Upload Missing Doc
                                        </button>
                                        <button className="acs2-btn-warning">
                                      ...
                                      <div className="acs2-inner-col" style={{ marginTop: '16px' }}>
                                        <h5 className="acs2-title" style={{ marginBottom: '12px' }}>
                                          System Tools
                                        </h5>
                                        <button
                                          className="acs2-btn-outline"
                                          style={{ marginBottom: '12px' }}
                                        >
                                          <i className="fa-solid fa-download"></i> Download
                                          Conditional Disbursal Slip
                                        </button>
                                        <button className="acs2-btn-outline">
                                          <i className="fa-solid fa-phone"></i> Contact Audit
                                          Officer
                                        </button>
                                      </div>
                                    </div>
        ...
        <div className="help-modal-overlay" onClick={() => setHelpDrawerAppId(null)}>
          <div className="help-drawer-content" onClick={(e) => e.stopPropagation()}>
            <div className="help-drawer-header">
              <h3>
                Help: Application{' '}
                {helpDrawerAppId < 1000 ? `APP-2023-894${helpDrawerAppId}` : helpDrawerAppId}
              </h3>
              <button onClick={() => setHelpDrawerAppId(null)}>
            ...
            <div className="help-drawer-body">
              ...
              <p>
                "You have received your funds, but your application is under temporary review. Our
                internal audit requires re-verification of your identity documents."
              </p>
              ...
              <ul>
                <li>
                  ...
                  <div>
                    <strong>Step 1:</strong> Click the <strong>Upload Missing Doc</strong> button on
                    your dashboard.
                  </div>
                </li>
                <li>
                  <i className="fa-solid fa-circle-check"></i>{' '}
                  <div>
                    <strong>Step 2:</strong> Provide a high-resolution scan (PDF or JPG, max 5MB) of
                    your linked Aadhar Card.
                  </div>
                </li>
                <li>
                  <i className="fa-solid fa-circle-check"></i>{' '}
                  <div>
                    <strong>Step 3:</strong> Submit the document. The audit team will review it
                    within 48 hours.
                  </div>
                </li>
              </ul>
              ...
              <p>
                "Audit Officer S. Sharma is assigned to your case. If you have questions about the
                specific rejection reason, you can contact them directly."
              </p>
              <button className="acs2-btn-outline">
                <i className="fa-solid fa-phone"></i> Contact Audit Officer
              </button>
            </div>
          </div>
        </div>
