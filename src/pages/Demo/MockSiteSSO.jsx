...
const MockSiteSSO = ({ siteName }) => {
  ...
  return (
    <div
      style={{ backgroundColor: '#f1f5f9', minHeight: '100vh', padding: '40px', color: '#334155' }}
    >
      <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
        ...
        >
          <i className="fa-solid fa-server" style={{ color: '#2563eb' }}></i> {siteName} Secure
          Portal
        </h1>
        ...
        {!isAuthenticated ? (
          ...
          >
            <i
              ...
              style={{ fontSize: '3.5rem', color: '#64748b', marginBottom: '20px' }}
            ></i>
            ...
            >
              {siteName} requires access to your verified profile data. Please login using your
              central SIH-CODEHAWKS identity to securely pull your information.
            </p>
            ...
            <form
              ...
              style={{ maxWidth: '350px', margin: '0 auto', textAlign: 'left' }}
            >
                  ...
                  <div className="ui-form-grid">
                    ...
                    <div className="ui-input-group">
                      ...
                      <div className="input-wrapper" style={{ background: '#f8fafc' }}>
                        ...
                        <input
                          type="text"
                          value={cd.phoneVerified ? 'YES' : 'NO'}
                          readOnly
                          style={{
                            color: cd.phoneVerified ? '#166534' : '#991b1b',
                            fontWeight: 700,
                          }}
                        />
                      </div>
                  ...
                  <div className="ui-form-grid">
                    ...
                    <div className="ui-input-group">
                      ...
                      <div className="input-wrapper" style={{ background: '#f8fafc' }}>
                        ...
                        <input
                          type="text"
                          value={id.aadhaarVerified ? 'YES' : 'NO'}
                          readOnly
                          style={{
                            color: id.aadhaarVerified ? '#166534' : '#991b1b',
                            fontWeight: 700,
                          }}
                        />
                      </div>
