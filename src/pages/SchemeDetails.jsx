                    ...
                    <div className="tab-content overview-content">
                        <div className="overview-left-card">
                            ...
                            <p className="description-text">
                                {scheme.description}
                                <br/><br/>
                                This scheme provides crucial support, eligibility applies to all verified individuals within the criteria. 
                                The benefits cover substantial financial aid or resources directly to the beneficiaries.
                            </p>
                            <h4>Key Benefits:</h4>
                            <ul>
                    ...
                    <div className="tab-content documentation-content">
                        ...
                        <div className="doc-col middle-col">
                            <div className="doc-upload-item">
                                <span><i className="fa-solid fa-square-check" style={{color: '#3b82f6'}}></i> Upload Land Record</span>
                                <button className="upload-btn-mini"><i className="fa-solid fa-arrow-up-from-bracket"></i></button>
                            </div>
                            <div className="doc-upload-item">
                                <span><i className="fa-solid fa-square-check" style={{color: '#3b82f6'}}></i> Upload Aadhaar</span>
                                <button className="upload-btn-mini"><i className="fa-solid fa-arrow-up-from-bracket"></i></button>
                            </div>
                            <div className="doc-upload-item">
                                <span><i className="fa-solid fa-square-check" style={{color: '#3b82f6'}}></i> Upload Bank Passbook</span>
                                <button className="upload-btn-mini"><i className="fa-solid fa-arrow-up-from-bracket"></i></button>
                            </div>
                        </div>
                        <div className="doc-col">
                            <h4>{scheme.name}</h4>
                            <p>Facilitates financial empowerment and health cover where applicable. Next projected disbursement for our bank branch.</p>
                        </div>
                    </div>
                );
            default:
                return (
                    <div className="tab-content empty-content">
                        <p>Detailed information for <strong>{activeTab}</strong> is currently being updated.</p>
                    </div>
                );
        }
    };
